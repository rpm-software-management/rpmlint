        ...
        for file in pkg.files:
            ...
            with open(pkg.dir_name() + '/etc/os-release', encoding='utf8') as f:
                ...
                if cpe_name != cpeid_xml_found:
                    # allow generic provides, eg. missing edition in /etc/os-release
                    if len(cpe_name) <= len(cpeid_xml_found) or cpe_name[len(cpeid_xml_found)] != ':' or cpe_name[0:len(cpeid_xml_found)] != cpeid_xml_found:
